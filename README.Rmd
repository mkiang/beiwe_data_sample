---
title: "About the Beiwe Sample Dataset"
# author: "Mathew Kiang"
...
See [`http://mkiang.carto.com`](https://mkiang.carto.com/viz/0de14940-cd4d-432c-86b2-b22f4848e74b/public_map) to interactively visualize these GPS data, including movement over time.
...
1. For each file with $< 50$ lines of data, I simply copy that entire file to each of the five fake users. 
